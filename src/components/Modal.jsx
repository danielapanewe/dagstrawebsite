...
function Modal({ show, onHide, imageInfo }) {
    ...
    return (
        <div className={openModal}>
            <div
                className="overlay fixed top-0 left-0 w-full h-[100vh] bg-[rgba(0,0,0,0.7)] z-[1900]"
                onClick={onHide}
            ></div>
            <div
                id="defaultModal"
                tabIndex="-1"
                aria-hidden="true"
                className="fixed top-0 left-0 grid items-center h-full lg:top-[50%] lg:left-[50%] z-[2000] p-4 overflow-x-hidden overflow-y-auto lg:translate-x-[-50%] lg:translate-y-[-50%] "
            >
